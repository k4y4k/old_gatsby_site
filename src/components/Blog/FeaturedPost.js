...
const FeaturedPost = () => (
  <FeaturedPostWrapper id="featured-blog-post">
    ...
    <FeaturedPostWords className="flex flex-col justify-flex-start text-left m-2 p-2">
      <BlogTitle>
        Really, really long blog post title 2: revenge of the sith 4: awakening in 3d
      </BlogTitle>

      <p className="mb-4">
        this is an excerpt. Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt,
        veniam inventore voluptatum impedit facilis, sapiente asperiores laborum quos eius ea
        delectus quo numquam quia totam quasi, eos dolor. Velit, labore!
      </p>
