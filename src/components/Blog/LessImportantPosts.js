...
import BlogTitle from '../Blog/Type/BlogTitle'
import Button from '../general/Button'

const LessImportantPosts = ({ className, children }) => {
  return (
    <div className={`${className} p-4 m-4`}>
      <BlogTitle>
        less important post; still an excellent example of fine English
        literature, though
      </BlogTitle>
      <p>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rem explicabo
        quam quod commodi non quaerat...
      </p>
