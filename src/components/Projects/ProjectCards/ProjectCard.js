...
const ProjectCard = ({ className }) => (
  <div className={`${className} project-card m-2 p-2 text-center`}>
    ...
    <h2 className="text-lg font-bold font-mono lowercase my-2">project title</h2>
    <p className="mb-2">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, consectetur. Doloribus voluptate
      itaque debitis eveniet facilis, qui, consequatur sed corrupti corporis laudantium in
      voluptatibus quos asperiores? Odio totam possimus repellat.
    </p>
